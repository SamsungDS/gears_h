...
class ExponentialScaleCorrection(nn.Module):
  ...
  def __call__(self, neighbour_distances, irreps):
    with jax.ensure_compile_time_eval():
      ...
      correctly_shaped_prefactors = jnp.repeat(self.prefactors, repeats=repeats, axis=-2, total_repeat_length=(self.max_ell + 1) ** 2)
    ...
    return irreps * correctly_shaped_prefactors * jnp.exp( - jnp.einsum('l..., pl -> p...', correctly_shaped_exponents, neighbour_distances))
